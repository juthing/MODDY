...
In all cases, you must read `/documentation/Components_V2.md` to know how to create V2 components. Also, all the text you write must use Moddy’s i18n system (see `/utils/i18n.py`). Furthermore, unless explicitly stated otherwise, you must only use Moddy’s “custom” emojis and not default emojis. If you need an emoji, icon, or anything else, don’t hesitate to ask.
