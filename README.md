# Moddy - Multifunctional Discord Bot
...
> [!CAUTION]
> Moddy is currently under active development. Expect frequent updates and changes.
...
**Moddy** is developed in **Python** using [`discord.py`](https://github.com/Rapptz/discord.py), relies on **PostgreSQL** as its database, and is hosted on [**Railway**](https://railway.com/)
